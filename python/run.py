...
if (scriptingType == "viewer"):
    ...
    Thread(target = a.renderTask(t_list=t_list, x_range=x_range, y_range=y_range,z_range=z_range, mode=2, flip_axis=flip_axis, transpose=transpose)).start()
