...
int main( void )
{
...
#if USE_WIN_VSPROJ
	GLuint shader_program_rayTrace = getShaderFromFile("../../../GLRenderingApps/src/rayTrace/rayt.vert",
							   "../../../GLRenderingApps/src/rayTrace/rayt.frag");
#else
	GLuint shader_program_rayTrace = getShaderFromFile("../../GLRenderingApps/src/rayTrace/rayt.vert",
							   "../../GLRenderingApps/src/rayTrace/rayt.frag");
#endif
	...
	// Read data
#if USE_WIN_VSPROJ
	std::ifstream file("../../../GLRenderingApps/data/frog.raw", std::ios::in | std::ios::binary);
#else
	std::ifstream file("../../GLRenderingApps/data/frog.raw", std::ios::in | std::ios::binary);
#endif
	if(!file.is_open()) {
